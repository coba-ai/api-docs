...
Sending MXN payments is a key feature of the Coba API, allowing you to programmatically initiate and manage payments in Mexican Pesos. On this page, you’ll find everything you need to send MXN payments through our API using USDC. {{ className: 'lead' }}
