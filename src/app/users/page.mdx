      ...
      <Properties>
        ...
        <Property name="additional_information" type="enum<string>">
          ...
          <Property name="additional_information.source_of_funds" type="string">
            ...
            For users of type <code>individual</code>, the client application must display the following declaration to the user and require explicit acceptance. Once accepted, the exact text below must be sent as the value of <code>source_of_funds</code>:
      ...
      -d '{
        "user": {
          ...
          "additional_information": {
            ...
            "platform_usage_reason": "The platform will be used to receive salary payments and transfer funds for personal expenses.",
